...
public class TARevisi {
    public static void main(String[] args) {
        ...
        Scanner scLaporan = new Scanner(System.in);
        ...
        if (isLoggedIn) {
            while (true) {
                ...
                if (inputSistem == 1) {
                        ...
                        for (int i = 0; i < currentIndex; i++) {
                            ...
                            if (karyawan[0].equals(idkaryawan)) {
                                ...
                                if (jmlembur > 0) {
                                    ...
                                    totalGaji = gajiBersih + gajiLembur;
                   ...
                   int inputLaporan;
                   String [] Laporan = {"Cetak Laporan", "Kembali"};
                   System.out.println("|-----------------------------------|");
                   System.out.println("|          Laporan Bulanan          |");
                   System.out.println("|-----------------------------------|");
                   System.out.println("|       1. Cetak Laporan            |");
                   System.out.println("|       2. Kembali                  |");
                   System.out.println("|-----------------------------------|");
                   System.out.print("  Pilih menu yang ingin anda masuki:   ");
                   inputLaporan = scLaporan.nextInt();

                   if (inputLaporan == 1) {
                        System.out.println("===========Cetak Laporan Bulanan==========");
                        for(int i=0; i<laporanCount; i++) {
                        System.out.println("ID Karyawan:" + laporanGaji[i][0]);
                        System.out.println("Jabatan:" + laporanGaji[i][1]);
                        System.out.println("Nama Karyawan" + laporanGaji[i][2]);
                        System.out.println("Gaji pokok karyawan" + laporanGaji[i][3]);
                        System.out.println("Pajak gaji karyawan" + laporanGaji[i][4]);
                        System.out.println("Tunjangan Karyawan" + laporanGaji[i][5]);
                        System.out.println("Gaji bersih karyawan" + laporanGaji[i][6]);
                        System.out.println("Gaji lembur karyawan" + laporanGaji[i][7]);
                        System.out.println("Total gaji karyawan" + laporanGaji[i][8]);
                        }
                }
            }
        }
